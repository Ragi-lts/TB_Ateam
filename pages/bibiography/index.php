...
<?php
$dbsn = 'mysql:dbname=tb220963db;host=localhost';
$user = "tb-220963";
$password ="rwd7r23gHn";
...
?>
        ...
        <div class="form-group">
          ...
          <textarea id="inputDescribe" class="form-control" rows="3" name="inputDescribe"
            placeholder="どのような時に参照したかを書いてくれるとありがたいです！" required></textarea>
        </div>
        <button id="register" name="register" class="btn btn-primary btn-block" type="submit" data-toggle="modal"
          data-target="#confirm">登録</button>
      </form>
